Shader "Universal Render Pipeline/Spine/Skeleton_customOutline" {
	Properties {
		...
		[HideInInspector][Toggle(_ZWRITE)] _ZWrite("Depth Write", Float) = 0.0
		[HideInInspector][MaterialToggle(_TINT_BLACK_ON)]  _TintBlack("Tint Black", Float) = 0
		[HideInInspector]_Color("    Light Color", Color) = (1,1,1,1)
		[HideInInspector]_Black("    Dark Color", Color) = (0,0,0,0)
		[HideInInspector] _StencilRef("Stencil Reference", Float) = 1.0

		_OutlineWidth("Outline Width", Range(0,8)) = 3.0
		_OutlineColor("Outline Color", Color) = (0.066,0.004,0.004,1)
		[HideInInspector]_OutlineReferenceTexWidth("Reference Texture Width", Int) = 1024
		_ThresholdEnd("Outline Threshold", Range(0,1)) = 0.25
		_OutlineSmoothness("Outline Smoothness", Range(0,1)) = 1.0
		[HideInInspector][MaterialToggle(_USE8NEIGHBOURHOOD_ON)] _Use8Neighbourhood("Sample 8 Neighbours", Float) = 0
